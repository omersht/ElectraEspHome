...
class ElectraClimate : public climate_ir::ClimateIR {
 public:
  ElectraClimate()
      : climate_ir::ClimateIR(RC3_TEMP_MIN, RC3_TEMP_MAX, 1.0f, true, true,
                              ...
                              {climate::CLIMATE_SWING_OFF, climate::CLIMATE_SWING_VERTICAL}, {climate::CLIMATE_PRESET_NONE, climate::CLIMATE_PRESET_SLEEP, climate::CLIMATE_PRESET_iFEEL}) {
                              }
 ...
 protected:
  ...
  /// create an ir code to send
  void transmit_state() override;
  /// encodes the recevied data in electra format and transmit it.
  void transmit_electra(ElectraCode &code);
